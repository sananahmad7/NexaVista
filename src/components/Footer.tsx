...
const Footer = () => {
  return (
    <footer className=" bg-[#252223] text-white font-outfit">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div className="text-2xl font-bold font-outfit">
                <span className="text-white font-outfit">Nexa Vista </span>
              </div>
            </div>

            <div className="space-y-4">
              <p className="text-[#A68353] font-semibold font-outfit text-lg">
          ...
          {/* Get Started Section */}
          <div className="lg:col-span-1">
            <h3 className="text-white font-bold font-outfit text-lg mb-6 relative">
              Get Started
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  href="/"
                  className="text-gray-300 font-outfit hover:text-[#A68353] transition-colors duration-200 text-sm"
                >
                  Home
                </Link>
              </li>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4">
              <li>
                <span className="text-gray-300 font-outfit hover:text-[#A68353] transition-colors duration-200 text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4 text-sm text-gray-400 font-outfit">
              <span className="font-outfit">©2024 CRAFT. Privacy</span>
              <span className="hidden md:inline">|</span>
              <Link
                href="/Term"
                className="hover:text-[#A68353] font-outfit transition-colors duration-200"
              >
                Term
              </Link>
              <span className="hidden md:inline">|</span>
            ...
            <div className="flex items-center space-x-4">
              <Link
                ...
                className="text-gray-400 font-outfit hover:text-[#A68353] transition-colors duration-200"
                aria-label="Facebook"
              >

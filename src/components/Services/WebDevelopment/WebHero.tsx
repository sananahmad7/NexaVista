...
const WebHero: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 font-outfit">
      {/* Main Hero Section */}
      <div className="flex items-start gap-2 lg:gap-3 font-outfit">
        {/* Left Section - Main Content */}
        <div className="flex-1 relative overflow-hidden text-white p-8 sm:p-12 lg:p-16 bg-[#031C20]/90 backdrop-blur-md font-outfit">
          {/* Gradient Overlay */}
          ...
          <div className="relative z-10 font-outfit">
            ...
            {/* CTA Button */}
            <button className="bg-white text-[#031C20] border border-red-800 px-4 py-3 rounded-full font-semibold text-lg hover:bg-gray-100 transition-all duration-300 hover:shadow-lg hover:scale-105 flex items-center space-x-2 group font-outfit">
              <span className="font-outfit">Define Your Vision</span>
        ...
        <div className="hidden lg:flex w-96 flex-col font-outfit">
          ...
          <div className="h-[400px] bg-[#031C20]/90 backdrop-blur-md text-white relative border-3 border-red-800 flex flex-col font-outfit">

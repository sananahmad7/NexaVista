    ...
    <div className=" mb-5 " style={{ backgroundColor: "#E8ECF3" }}>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          {/* CTA Button */}
          <button className="bg-[#092125] text-white px-6 py-3 rounded-full font-semibold text-sm hover:bg-[#092125] transition-all duration-300 hover:shadow-lg hover:scale-105 flex items-center space-x-2 group mb-12">

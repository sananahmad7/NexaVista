    ...
    <section className="bg-[#27374D]  text-white py-16 px-9 lg:px-12">
      <div className="max-w-8xl mx-auto">
        ...
        <div className="lg:hidden">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <h1 className="text-4xl font-outfit">
                  <span className="text-[#9DB2BF] relative">
                    Solutions
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex -space-x-3">
                  <div className="w-14 h-14 rounded-full border-3 border-[#27374D] overflow-hidden">
                    <Image
          ...
          {/* Stats Section */}
          <div className="bg-[#526D82] text-white p-8 rounded-b-2xl">
        ...
        <div className="hidden container mx-auto lg:block">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="pt-4">
                <div className="relative w-32 h-32">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <svg viewBox="0 0 128 128" className="w-full h-full">
                      <path
                        ...
                        fill="none"
                      />
                      <text className="fill-[#DDE6ED] text-[10px] uppercase tracking-[0.3em] font-outfit">
                  ...
                  <div className="absolute inset-[30%] rounded-full bg-[#9DB2BF] flex items-center justify-center">
                    <svg
                      className="w-5 h-5 text-[#27374D]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
            ...
            <div className="flex gap-0">
              ...
              <div className="bg-[#526D82] text-white p-8 rounded-r-2xl shadow-2xl w-[280px] flex flex-col justify-center">
                <div className="space-y-8">
                  <div>

    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-r from-[#252223] to-[#252223]/90 py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-6xl font-outfit mb-6 text-white">
            Get In <span className="text-[#A68353]">Touch</span>
          </h1>
          <p className="text-sm lg:text-lg text-white/80 max-w-2xl mx-auto leading-relaxed font-outfit">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid lg:grid-cols-2 gap-20">
            ...
            <div className="space-y-12 ">
              <div>
                <h2 className="text-3xl font-outfit mb-6 text-[#A68353]">
                  Let's Start a Conversation
                </h2>
                <p className="text-gray-600 text-lg font-outfit leading-relaxed mb-8">
              ...
              <div className="space-y-6">
                <div className="border border-gray-200 p-6 hover:border-[#A68353]/40 transition-colors">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-outfit mb-1 text-gray-900">
                        Email Us
                      </h3>
            ...
            <div className="bg-gray-50 border border-gray-300 p-8 shadow-xl">
              <h3 className="text-2xl font-outfit mb-6 text-[#A68353]">
                Send Us a Message
              </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label
                      htmlFor="firstName"
                      className="block text-sm font-outfit mb-2 text-gray-700"
                    >
                      First Name *
                    </label>
                    <input
                ...
                <button
                  type="submit"
                  className="w-full bg-[#A68353] text-white font-outfit py-4 px-6 hover:bg-[#A68353]/90 transition-colors duration-200 flex items-center justify-center space-x-2 group"
                >
          ...
          <div className="mt-24 text-center bg-gray-50 border border-gray-200 p-12">
            <h3 className="text-3xl font-outfit mb-4 text-[#A68353]">
              Ready to Get Started?
            </h3>
            <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto font-outfit">
              Join hundreds of satisfied clients who have trusted us with their
              digital transformation journey.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-[#A68353] text-white font-outfit py-3 px-8 hover:bg-[#A68353]/90 transition-colors">
                Schedule a Call
              </button>
              <button className="border-2 border-[#A68353] text-[#A68353] font-outfit py-3 px-8 hover:bg-[#A68353] hover:text-white transition-colors">
                View Our Work
              </button>
            </div>
          </div>
